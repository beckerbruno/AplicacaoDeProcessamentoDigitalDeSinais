...
% Experiência E8: Projeto e implementação de filtros IIR
% Prof. Denis Fernandes 
% Ultima atualizacao: 12/05/2020
...
%**************************************************************************
a = [1 0 0 0 0 0 0 0]; % coeficientes do filtro utilizado na FuncaoE8
b = [1 0 0 0 0 0 0 0]; % coeficientes do filtro utilizado na FuncaoE8
NFILT = max(length(a),length(b))-1; % ordem do filtro utilizado na FuncaoE8
zi = zeros([1 NFILT]); % condições iniciais para o filtro da FuncaoE8
%**************************************************************************
