...
ap = 1;      % Máxima atenuação na banda de passagem (dB)
as = 20;     % Mínima atenuação na banda de rejeição (dB)
...
% --- Passo 1: Pré-distorcer as frequências (Transformação Bilinear) ---
...
% --- Passo 2: Garantir a simetria do gabarito ---
...
% --- Passo 3: Transformar para especificações de um passa-baixas normalizado ---
...
% --- Passo 4: Calcular a ordem (N) e a freq. de corte (W0) do Butterworth ---
...
% --- Passo 5: Determinar os coeficientes do filtro analógico passa-baixas ---
% Usando a representação em Espaço de Estados (A,B,C,D) como sugerido
[A,B,C,D] = butter(N, W0, 's');

% --- Passo 6: Transformar de passa-baixas para rejeita-banda analógico ---
...
% --- Passo 7: Aplicar a transformação bilinear para obter o filtro digital ---
